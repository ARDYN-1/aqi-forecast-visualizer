    ...
    <div className="flex flex-col items-center justify-center p-8">
      ...
      <div className="relative mb-4">
        <div className="absolute inset-0 animate-ping">
          <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-green-500 rounded-full opacity-20"></div>
        </div>
      ...
      <div className="relative mb-4">
        <div className="flex space-x-1">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className={`${sizeClasses[size]} bg-gradient-to-r from-blue-500 to-green-500 rounded-full animate-bounce`}
